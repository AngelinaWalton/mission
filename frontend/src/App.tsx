...
class Team extends React.Component <{name:string; city: string; school: string; state: string;}>
{
  render() {
    ...
    return (
      <div>
        <h2>{school.school}</h2>
        <p>Mascot: {school.name}</p>
        <p>Location: {school.city}, {school.state}</p>
      </div>
    )
  }
}
